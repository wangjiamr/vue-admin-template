<template>
  <div class="app-container" v-loading="loading"
    ...
    <el-dialog :title='id?"Edit Car":"New Car"' :visible.sync="dialogVisible" width="30%" close="resetForm">
    ...
    <!--Effect-->
    <el-dialog :title='car?car.title+"  Effect List":""' :visible.sync="dialogVisibleListEffect" width="50%">
      ...
      <el-table
        ...
        <el-table-column label="Car" width="180">
          <template slot-scope="scope">
