<template>
  <div class="app-container" v-loading="loading"
    ...
    <el-table  v-loading="listLoading" :data="list"  element-loading-text="Loading" border stripe  fit  highlight-current-row>
      ...
      <el-table-column label="operate">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="success"  @click="up( scope.row)">Up </el-button>
          <el-button size="mini" type="success"  @click="down( scope.row)">Down </el-button>
    ...
    <el-dialog :title='id?"Edit Plan":"New Plan"' :visible.sync="dialogVisible" width="30%" close="resetForm">
    ...
    <!--Effect-->
    <el-dialog :title='plan?plan.title+"  Effect List":""' :visible.sync="dialogVisibleListEffect" width="50%">
...
<script>
  ...
  methods: {
    ...
    effectDialogShow(row){
      ...
      this.plan = row
      this.paramsEffect.planId=row.id
