<template>
  <div class="app-container" v-loading="loading"
    ...
    <el-table  v-loading="listLoading" :data="list"  element-loading-text="Loading" border stripe  fit  highlight-current-row>
      ...
      <el-table-column label="操作" width="235">
        <template slot-scope="scope">
          ...
          <el-popover  placement="top"   trigger="hover">
              <el-button size="mini" type="success"  @click="up( scope.row)">上移 </el-button>
              <el-button size="mini" type="success"  @click="down( scope.row)">下移 </el-button>
    ...
    <!--Effect-->
    <el-dialog :title='plan?plan.title+"  增益列表":""' :visible.sync="dialogVisibleListEffect" width="50%">
      ...
      <el-table
        ...
        <el-table-column label="日常" width="180">
          <template slot-scope="scope">
