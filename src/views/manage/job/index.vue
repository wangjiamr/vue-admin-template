<template>
  <div class="app-container" v-loading="loading"
    ...
    <el-table-column label="岗位名称" width="150">
      ...
      <el-table-column label="岗位薪水" width="120">
        <template slot-scope="scope">
    ...
    <el-dialog :title='id?"编辑":"新建"' :visible.sync="dialogVisible" width="30%" close="resetForm">
      <el-form label-width="100px" :model="form" :rules="rules" ref="form">
        ...
        <el-form-item label="岗位薪水:" prop="price">
    ...
    <!--effect-->
    <el-dialog :title='job?job.title+"  增益列表":""' :visible.sync="dialogVisibleListEffect" width="50%">
...
<script>
  ...
  import {addEvent,eventList,module} from'@/api/job'
