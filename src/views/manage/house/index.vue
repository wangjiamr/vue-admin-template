<template>
  <div class="app-container" v-loading="loading"
    ...
    <el-dialog :title='id?"Edit House":"New House"' :visible.sync="dialogVisible" width="30%" close="resetForm">
    ...
    <!--Effect-->
    <el-dialog :title='house?house.title+"  Effect List":""' :visible.sync="dialogVisibleListEffect" width="50%">
      ...
      <el-table
        ...
        <el-table-column label="House" width="180">
          <template slot-scope="scope">
            {{ scope.row.houseId.title }}
          </template>
        </el-table-column>
...
<script>
  import {getList, add, edit, enable, disable,getOperation,getAttr} from '@/api/house'
  import {effectList,addEffect,editEffect,deleteEffect} from '@/api/house'
  import {addEvent,eventList,module} from'@/api/house'
  ...
  export default {
    ...
    methods: {
      ...
      effectDialogShow(row){
        ...
        this.house = row
        this.paramsEffect.houseId=row.id
