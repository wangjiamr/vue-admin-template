<template>
  <div class="app-container" v-loading="loading"
    ...
    <el-table  v-loading="listLoading" :data="list"  element-loading-text="Loading" border stripe  fit  highlight-current-row>
      <el-table-column label="房屋" width="170">
    ...
    <el-dialog :title='id?"编辑":"新建"' :visible.sync="dialogVisible" width="30%" close="resetForm">
      <el-form label-width="100px" :model="form" :rules="rules" ref="form">
        <el-form-item label="房屋:" prop="title">
    ...
    <!--Effect-->
    <el-dialog :title='house?house.title+"  增益列表":""' :visible.sync="dialogVisibleListEffect" width="50%">
      ...
      <el-table
        ...
        <el-table-column label="房屋" width="180">
          <template slot-scope="scope">
