<template>
  <div class="app-container" v-loading="loading"
    ...
    <el-dialog :title='id?"Edit Clothes":"New Clothes"' :visible.sync="dialogVisible" width="30%" close="resetForm">
    ...
    <!--Effect-->
    <el-dialog :title='clothes?clothes.title+"  Effect List":""' :visible.sync="dialogVisibleListEffect" width="50%">
      ...
      <el-table
        ...
        <el-table-column label="Clothes" width="180">
          <template slot-scope="scope">
            {{ scope.row.clothesId.title }}
          </template>
        </el-table-column>
...
<script>
  import {getList, add, edit, enable, disable,getOperation,getAttr} from '@/api/clothes'
  import {effectList,addEffect,editEffect,deleteEffect} from '@/api/clothes'
  import {addEvent,eventList,module} from'@/api/clothes'
  ...
  export default {
    ...
    methods: {
      ...
      effectDialogShow(row){
        ...
        this.clothes = row
        this.paramsEffect.clothesId=row.id
