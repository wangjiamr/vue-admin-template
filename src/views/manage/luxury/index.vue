<template>
  <div class="app-container" v-loading="loading"
    ...
    <el-table  v-loading="listLoading" :data="list"  element-loading-text="Loading" border stripe  fit  highlight-current-row>
      ...
      <el-table-column label="buyPrice" width="100">
        <template slot-scope="scope">
          {{ scope.row.buyPrice }}
        </template>
      </el-table-column>
      <el-table-column label="sellPrice" width="100">
        <template slot-scope="scope">
          {{ scope.row.sellPrice }}
        </template>
      </el-table-column>
    ...
    <el-dialog :title='id?"Edit Luxury":"New Luxury"' :visible.sync="dialogVisible" width="30%" close="resetForm">
      <el-form label-width="80px" :model="form" :rules="rules" ref="form">
        <el-form-item label="Title:" prop="title">
          <el-input type="text" v-model="form.title"></el-input>
        </el-form-item>
        <el-form-item label="buyPrice:" prop="buyPrice">
    ...
    <!--Effect-->
    <el-dialog :title='luxury?luxury.title+"  Effect List":""' :visible.sync="dialogVisibleListEffect" width="50%">
      ...
      <el-table
        ...
        <el-table-column label="Luxury" width="180">
          <template slot-scope="scope">
            {{ scope.row.luxuryId.title }}
          </template>
        </el-table-column>
...
<script>
  import {getList, add, edit, enable, disable,getOperation,getAttr} from '@/api/luxury'
  import {effectList,addEffect,editEffect,deleteEffect} from '@/api/luxury'
  import {addEvent,eventList,module} from'@/api/luxury'
  ...
  export default {
    ...
    methods: {
      ...
      effectDialogShow(row){
        ...
        this.luxury = row
        this.paramsEffect.luxuryId=row.id
